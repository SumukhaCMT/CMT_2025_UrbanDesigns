...
var revapi2,
  ...
  jQuery(function() {
    ...
    if(tpj("#rev_slider_2_1").revolution == undefined){
        ...
        gridheight:"340,340,340,800",
        perspective:600,
        perspectiveType:"global",
        editorheight:"340,768,340,800",
        responsiveLevels:"1240,1240,778,480",
  ...
  jQuery(function() {
    ...
    if(tpj("#rev_slider_3_1").revolution == undefined){
        ...
        sliderType:"standard",
        visibilityLevels:"1805,1240,778,480",
        gridwidth:"1805,1240,778,480",
        gridheight:"707,707,450,350",
        spinner:"spinner0",
        perspective:600,
        perspectiveType:"local",
        editorheight:"707,707,450,350",
        responsiveLevels:"1805,1240,778,480",
        disableProgressBar:true,
          navigation: {
            onHoverStop:false,
            arrows: {
